...
| N5 | CONTROL-GAP | 3, 11 | `onModuleInit` rewrites **every** invoice payment on every boot, unscoped by tenant, errors swallowed | `inventory/invoice/payment/payment.module.ts:42-55` |
