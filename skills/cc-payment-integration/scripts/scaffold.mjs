...
// 4c. Per-product checkout copy/meta (logo, benefits, support, tagline, charge descriptor).
{
  ...
  const meta = {
    ...
    supportPhone: copy.supportPhone || '+31 970 1020 8696',
    ...
    companyName: copy.companyName || 'Sam Media B.V.',
    companyAddress: copy.companyAddress || 'Van Diemenstraat 356, 1013 CR Amsterdam, The Netherlands'
  };
